...
<details>
  ...
  * Data para entrega final do projeto: `14/04/2023 14:00`
...
<details>
  ...
  - Use o comando: `git clone git@github.com:tryber/sd-032-a-project-playground-functions.git`
  - Entre na pasta do repositório que você acabou de clonar:
    - `cd sd-032-a-project-playground-functions`
  ...
  - Crie uma branch à qual você vai submeter os `commits` de seu projeto
    ...
    - Exemplo: `git checkout -b joaozinho-sd-032-a-project-playground-functions`
  ...
  - Usando o exemplo anterior: `git push -u origin joaozinho-sd-032-a-project-playground-functions`

  6. Crie um novo `Pull Request` _(PR)_

  - Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-032-a-project-playground-functions/pulls)
  ...
  - Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-032-a-project-playground-functions/pulls) e confira que o seu _Pull Request_ está criado
...
Link: [Formulário de avaliação do projeto](https://be-trybe.typeform.com/to/ZTeR4IbH#cohort_hidden=CH32-A&template=betrybe/sd-0x-project-playground-functions)
